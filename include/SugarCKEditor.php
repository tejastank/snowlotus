...
/**
 * PHP wrapper class for Javascript driven CKEditor WYSIWYG HTML editor
 */
class SugarCKEditor {
	var $jsroot = "include/javascript/ckeditor/";
	...
	/**
	 * Returns the Javascript necessary to initialize a CKEditor instance for a given <textarea> or <div>
	...
	function getInstance($targets = "") {
		...
		$path = getJSPath('include/javascript/ckeditor/ckeditor.js');
		$ret =<<<eoq
...
eoq;
    ...
    /**
     * This function takes in html code that has been produced (and somewhat mauled) by CKEditor
