...
class xPhotobucketAccountsViewEdit extends ViewEdit
{
...
function photobucket_login()
{
	...
	if (oauth_token == "") {
		...
		_form.action.value='photobucketlogin';
...
EOQ;
		echo $javascript;
		if (!empty($this->bean->oauth_token)) {
			$url = $this->bean->get_sign_in_url();
