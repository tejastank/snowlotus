...
/**
 * xeBaySellerListsViewUpdate.php
 * 
...
class xeBaySellerListsViewUpdate extends SugarView 
{
 	/**
    ...
    public function display()
    {
      ...
      // $ss->assign("FILE_EXCHANGE_URL", "<a href=\"javascript: void(0);\" onclick=\"window.location.href='index.php?entryPoint=FileExchange&module=xeBaySellerLists&action=index&all=true'\" >".$mod_strings['LBL_DOWNLOAD_FILE_EXCHANGE']."</a>");
...
{
   var href="index.php?entryPoint=FileExchange&module=xeBaySellerLists&action=index&all=true";
...
EOQ;
      $ss->assign("JAVASCRIPT", $javascript);
		echo $ss->fetch("modules/xeBaySellerLists/tpls/update.tpl");
 	}
}
