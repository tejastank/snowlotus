...
if(ACLController::checkAccess('xInventories', 'import', true))$module_menu[]=Array("index.php?module=Import&action=Step1&import_module=xInventories&return_module=xInventories&return_action=index", $app_strings['LBL_IMPORT'], "Import", 'xInventories');
// if(ACLController::checkAccess('xPinnedItems', 'edit', true)) $module_menu[] = array("index.php?module=xPinnedItems&action=EditView&return_module=xPinnedItems&return_action=DetailView", $mod_strings['LNK_NEW_PINNED_ITEM'],"CreatePinnedItems","xPinnedItems");
