...
$GLOBALS['log']->info("xInventory detail view");

$xtpl=new XTemplate ('modules/xInventories/EditViewMain.html');
...
if(!empty($focus->category_name))
    $xtpl->assign("CATEGORY_NAME", $focus->category_name);
...
//Bug45632
if(isset($focus->category_id)) $xtpl->assign("CATEGORY_ID", $focus->category_id); else $xtpl->assign("CATEGORY_ID", "");
//Bug45632
