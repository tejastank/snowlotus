...
function additionalDetailsxVendor($fields) {
	static $mod_strings;
	global $app_strings;
	...
	return array('fieldToAddTo' => 'NAME', 
				 ...
				 'editLink' => "index.php?action=EditView&module=xVendors&return_module=xVendors&record={$fields['ID']}", 
				 'viewLink' => "index.php?action=DetailView&module=xVendors&return_module=xVendors&record={$fields['ID']}");
}
