...
$popupMeta = array(
	...
	'whereClauses' => array(
		'name' => 'xvendors.name',
		'billing_address_city' => 'xvendors.billing_address_city',
		'phone_office' => 'xvendors.phone_office'
	),
	'searchInputs' => array('name', 'billing_address_city', 'phone_office'),
	'create' => array(
		'formBase' => 'xVendorFormBase.php',
		'formBaseClass' => 'xVendorFormBase',
		'getFormBodyParams' => array('','','xVendorSave'),
		'createButton' => 'LNK_NEW_XVENDOR'
	),
	'listviewdefs' => array(
		'NAME' => array(
			'width' => '40', 
