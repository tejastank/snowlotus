...
// retrieve $_POST values out of the $_SESSION variable - placed in there by xVendorFormBase to avoid the length limitations on URLs implicit with GETS
...
$moduleName = $GLOBALS['app_list_strings']['moduleList']['xVendors'];
...
while(($row=$db->fetchByAssoc($result)) != null) {
	$i++;
	$duplicatexVendors[$i] = $row;
}

$xtpl->assign('FORMBODY', $xvendorForm->buildTableForm($duplicatexVendors,  'xVendors'));

$input = '';
foreach ($xvendor->column_fields as $field)
{	
