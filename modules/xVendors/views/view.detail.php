...
class xVendorsViewDetail extends ViewDetail {


 	function xVendorsViewDetail(){
 		parent::ViewDetail();
 	}
 	 ...
 	 * a popup and allow you to copy the xvendor's address into the selected contacts.
 	...
 	function display(){
		...
		if(ACLController::checkAccess('Contacts', 'edit', true)) {
			$push_billing = '<span class="id-ff"><button class="button btn_copy" title="' . $mod_strings['LBL_PUSH_CONTACTS_BUTTON_LABEL'] . 
								 '" type="button" onclick=\'open_contact_popup("Contacts", 600, 600, "&xvendor_name=' .
