...
if(ACLController::checkAccess('xActiveListings', 'reassociate', true))$module_menu[]=Array("index.php?module=xActiveListings&action=Reassociate&return_module=xActiveListings&return_action=index", $mod_strings['LNK_REASSOCIATE_XACTIVELISTINGS'],"Reassociate", 'xActiveListings');
...
if(ACLController::checkAccess('xActiveListings', 'update', true))$module_menu[]=Array("index.php?module=xActiveListings&action=Update&return_module=xActiveListings&return_action=index", $mod_strings['LNK_UPDATE_XACTIVELISTINGS'],"Update", 'xActiveListings');
